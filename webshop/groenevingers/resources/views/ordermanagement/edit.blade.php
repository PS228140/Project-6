                ...
                <div class="p-6 text-gray-900 dark:text-gray-100 flex flex-col gap-2">
                    ...
                    @foreach ($order->orderrow as $orderrow)
                        ...
                        <form
                            ...
                            method="post" class="grid grid-cols-4 grid-rows-1 py-2">
                            @csrf
                            @method('DELETE')
                            <div class="flex">
