                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('management.store') }}" method="POST" class="grid max-w-xl">
                        ...
                        <div class="mt-6">
                            ...
                            <input id="quantity" name="quantity" min="0" max="100" class="border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm w-full" type="number">
                        </div>
