    ...
    <div class="wrapper">
        ...
        <form class="order-form" action="{{ route('order.setCustomerInformation') }}" method="post">
            ...
            <div class="input-wrapper">
                ...
                <input class="input-field" id="email" name="email" type="email" placeholder="your.email@email.com" />
            </div>

            <div class="input-wrapper">
                <label class="input-label" for="phone">Telefoonnummer</label>
                <input class="input-field" id="phone" name="phone" type="tel" placeholder="+316123456789" />
            </div>

            <div class="input-wrapper">
                <label class="input-label" for="address">Adres</label>
                <input class="input-field" id="address" name="address" type="text" placeholder="Straatnaam en huisnummer" />
            </div>
